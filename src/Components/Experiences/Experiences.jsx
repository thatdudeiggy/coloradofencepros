...
const skillCategories = [
  {
    title: "Design Tools",
    description: "Modern design tools I use to create intuitive and accessible user interfaces.",
    skills: [
  ...
  },
  {
    ...
    description: "Languages and frameworks for building responsive and dynamic UIs.",
    skills: [
  ...
  },
  {
    ...
    description: "Technologies I use to handle logic, APIs, and persistent data storage.",
    skills: [
